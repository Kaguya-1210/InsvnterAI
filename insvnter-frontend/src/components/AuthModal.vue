...
const registerForm = ref({ username: '', email: '', password: '', confirmPassword: '', captcha: '' })
    ...
    <div class="auth-dialog">
      ...
      <template v-if="activeTab === 'login'">
        <NForm class="auth-form" @submit.prevent="handleLogin">
          <NFormItem path="username">
            <NInput v-model:value="loginForm.username" placeholder="用户名" round />
          </NFormItem>
        ...
        <div class="auth-switch">
          还没有账号？<NButton text type="primary" size="tiny" @click="activeTab = 'register'">立即注册</NButton>
        </div>
      </template>
      ...
      <template v-else>
        <NForm class="auth-form" @submit.prevent="handleRegister">
          <NFormItem path="username">
            <NInput v-model:value="registerForm.username" placeholder="用户名" round />
          </NFormItem>
          <NFormItem path="email">
            <NInput v-model:value="registerForm.email" placeholder="邮箱地址" round />
          </NFormItem>
          <NFormItem path="password">
            <NInput v-model:value="registerForm.password" type="password" show-password-on="click" placeholder="密码" round />
          </NFormItem>
